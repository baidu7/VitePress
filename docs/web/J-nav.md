...
### ?? 项目名片
- **项目仓库**：[baidu7/J-nav](https://github.com/baidu7/J-nav)
...
1. **部署 J-nav**：
   Fork [J-nav 仓库](https://github.com/baidu7/J-nav)，开启 GitHub Pages 即可拥有你的域名。

2. **管理书签**：
   在 Edge 或 GitHub 中安装 [J-Mark](https://github.com/baidu7/J-Mark)。在插件中整理好你的分类。
